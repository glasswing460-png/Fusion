...
const CACHE = 'openorb-v1';
const SHELL = ['./', './index.html', './manifest.webmanifest', './openorb-192.png', './openorb-512.png'];
      ...
      return fetch(req).then((res) => {
        try {
          const cacheable = url.origin === location.origin ||
            /cdn\.jsdelivr\.net|cdnjs\.cloudflare\.com|unpkg\.com|fonts\.googleapis\.com|fonts\.gstatic\.com/.test(url.host);
